...
/** @type {string} */
const CACHE_VERSION = '1745947173|17428477592';
/** @type {string} */
const CACHE_PREFIX = 'Letter Tracing P-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'LetterTracingPrototype.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["LetterTracingPrototype.html","LetterTracingPrototype.js","LetterTracingPrototype.offline.html","LetterTracingPrototype.icon.png","LetterTracingPrototype.apple-touch-icon.png","LetterTracingPrototype.audio.worklet.js","LetterTracingPrototype.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["LetterTracingPrototype.wasm","LetterTracingPrototype.pck"];
